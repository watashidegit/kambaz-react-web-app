...
export default function Kambaz() {
  ...
  // fetch all available courses adding a new property: enrolled state
  ...
  useEffect(() => {
    if (showAllCourses) {
      fetchCourses(); // all courses with enroll button
    } else {
      findCoursesForUser(); // fetch only enrolled courses
    }
